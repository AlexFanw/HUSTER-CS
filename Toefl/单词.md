...
|     rim      |              |       echo       |           |
|    brink     |              |   ultrasonics    |           |
| constituent  |  component   |      sonar       |           |
|  dimension   |              |     acoustic     |           |
|  elasticity  |              |       band       |           |
|   cohesion   |              |      charge      |           |
|   pressure   |              |   electricity    |           |
|   gravity    |              |  electromagnet   |           |
|   impetus    |              | electromagnetism |           |
|   release    |              |    electronic    |           |
|  decelerate  |              |   electronics    |           |
| precipitate  |              |    amplifier     |           |
|   expedite   |              |     battery      |           |
|    quiver    |              |       chip       |           |
|     jar      |              |    conductor     |           |
|  vibration   |              |    insulator     |           |
|  discharge   |              |      magnet      |           |
|    shrink    |              |    magnetism     |           |
|   diffuse    |    spread    |  semiconductor   |           |
|     emit     |              |    transistor    |           |
|  transpire   |              |   ultraviolet    |           |
|  constitute  |              |    microwave     |           |
|    eject     |              |    mechanics    |n.力学           |
|   radiate    |              |   gravitation    |           |
|   molecule   |              |   oscillation    |           |
|     ion      |              |     statics      |           |
|   electron   |              |    relativity    |           |
|   neutron    |              |     velocity     |           |
|   nuclear    | adj.原子核的 |     dynamics     |           |
|   nucleus    |              |      force       |           |
|   physics    |              |     current      |           |
|    fusion    |              |    accelerate    |           |
| thermometer  |              |   acceleration   |           |
| temperature  |              |   transparent    |           |
|     thaw     |              |      opaque      |           |
|  centigrade  |              |   translucent    |           |
|     clot     |              |     optical      |           |
|  sublimate   |              |      optics      |           |
| distillation |              |       ray        |           |
|    chaos     |              |     spectrum     |           |
|   clutter    |              |    wavelength    |           |
| equilibrium  |              |    magnifier     | n.放大镜🔍 |
|   density    |              |       lens       |           |
|    liquid    |              |      vortex      |           |
|    dilute    |              |      buffer      |           |
|  dehydrate   |              |     fission      |  n.裂变   |
|  declivity   |              |                  |           |
